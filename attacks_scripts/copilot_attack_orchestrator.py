"""
Orquestrador para automatizar a execução dos scripts de ataque usando o Copilot.
"""
...
from copilot_code_completion_automation import run_automation
...
from pt_copilot_attack_orchestrator import main as pt_main
...
class AttackOrchestrator:
    ...
    def run_full_attack_pipeline(self, num_questions: int = None, timestamp: str = None):
        ...
        3. Executa a automação do Copilot para cada arquivo de ataque
        ...
        try:
            ...
            # Passo 3: Executar automação do Copilot
            print("Passo 3: Iniciando automação do Copilot...")
            print("ATENÇÃO: Não use o computador durante a automação!")
            
            run_automation(output_dir, num_questions=num_questions)

            end_time_2 = time.time()
            print(f"Tempo total de execução da automação de autocomplete do Copilot: {end_time_2 - start_time_2:.2f} segundos")
            time.sleep(2)
