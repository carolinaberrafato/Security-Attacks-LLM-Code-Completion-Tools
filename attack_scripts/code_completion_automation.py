...
def run_automation(diretorio_original):
    """
    Executa a automação do Cursor para os arquivos no diretório especificado.
    
    Args:
        diretorio_original: Caminho para o diretório com os arquivos de ataque
    """
    ...
    diretorio_original = Path(diretorio_original)
...
if __name__ == '__main__':
    # Se executado diretamente, usa o diretório padrão
    diretorio_home = Path.home()
    diretorio_padrao = diretorio_home / 'Documents' / 'codes_teste_final'
    run_automation(diretorio_padrao)